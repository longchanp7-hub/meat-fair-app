...
const files=['index.html','app.js','status.mjs','styles.css','data/brands.json','data/fairs.json','data/stores.json'];
...
for(let attempt=1;attempt<=12;attempt++){
  try{
    ...
    console.log('Public app verified: all seven deployed files match their committed SHA256');
    process.exit(0);
