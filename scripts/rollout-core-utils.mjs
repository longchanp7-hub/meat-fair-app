...
export const CORE_ROLLOUT_IDS=['washoku-sato','amiyakitei','onyasai','nikusho-sakai'];
...
export function coreTitleRelevant(brandId,title=''){
  if(!CORE_ROLLOUT_IDS.includes(brandId))return false;
...
export function rawCoreUrls(brandId,html,base){
  const patterns={
...
export function allowedCorePath(brandId,url){
...
export function adjustCoreFields(brandId,title,text,base){
  if(!CORE_ROLLOUT_IDS.includes(brandId))return base;
