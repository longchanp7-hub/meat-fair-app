...
const lunch={...common,kind:'menu',parents:[{campaignId:'c',parentHash:'hash'}],rank:35,title:'ランチ',imageUrl:'https://official.example/lunch.jpg'};
const banquet={...common,kind:'menu',parents:[{campaignId:'c',parentHash:'hash'}],rank:40,title:'宴会',imageUrl:'https://official.example/banquet.jpg'};
