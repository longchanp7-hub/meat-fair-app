import {reviewedCatalogFallbacks} from './catalog-reviewed-bridge.mjs?v=20260915-integrated1';
import {campaignStatus} from './status.mjs';
import {renderMediaAssets,selectMedia} from './gallery.mjs?v=20260915-integrated1';
...
export function renderCatalog(brand,data,fairs,media,now=new Date(),offersData=null){
  ...
  const entries=[...current,...reviewedCatalogFallbacks(offersData,brand.id,current,now)];
